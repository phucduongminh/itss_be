...
namespace ItssProject.Services
{
    public class GetDataService : IGetDataService
    {
        ...
        //}
        public List<CoffeeShop> GetCoffeeShopByRequest(string Status, string Name, string Address, bool Service)
        {
            try
            {
                var listCoffeeShop = new List<CoffeeShop>();
                listCoffeeShop = (from shop in _applicationContext.CoffeeShops.AsNoTracking()
                                  where (shop.Service == Service && shop.Description == Status && shop.Name == Name && shop.Address.Contains(Address) == true)
        ...
        public void AddInformationOfCoffeeShop(RequestAddCoffeeShopModel Model)
        {
            try
            {
                if (Model.Name == null || Model.Address == null || Model.Gmail == null || Model.ContactNumber == null)
                {
                    throw new ArgumentException("Invalid field");
                }
